...
public partial class TaskDialog : Window
{
    ...
    public TaskDialog(DotNet_Lab01_Core.ParacTask task) : this()
    {
        Title = "Edit task";
        TitleTextBox.Text = task.TaskName;
        DescriptionTextBox.Text = task.TaskDescription ?? "";
        DifficultyTextBox.Text = task.Difficulty.ToString();
        CreditsTextBox.Text = task.Credits.ToString();
        ProgressTextBox.Text = task.Progress.ToString();
    ...
    public string TaskDescription => DescriptionTextBox.Text.Trim();
    public List<string> Tags => ParseTags(TagsTextBox.Text);
    public int Difficulty { get; private set; }
    public int Credits { get; private set; }
    public int Progress { get; private set; }
    public DateTime Deadline => DeadlinePicker.SelectedDate ?? DateTime.Now.AddDays(7);
    ...
    private bool ValidateInput()
    {
        ...
        {
            ShowValidation("Enter task title.");
            return false;
        }
